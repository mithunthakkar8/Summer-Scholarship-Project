...
LOG_DIR = "/nesi/project/vuw04485/pisa_sem_pipeline/logs"
...
logger.info("===== Tabula DistilGPT2 PIPELINE STARTED =====")
...
sem_vars = [
    ...
    "SC064Q07WA",
    "ST004D01T", "ST001D01T",
    "MISCED", "ESCS", "AGE", "IMMIG", "MCLSIZE", "SCHSIZE"
]
...
for i in range(1, N_FINAL_REPS + 1):
    ...
    out_path = os.path.join(
        FINAL_SYN_DIR,
        f"synthetic_tabula_distilgpt2_bestepoch_rep_{i}.csv"
    )
