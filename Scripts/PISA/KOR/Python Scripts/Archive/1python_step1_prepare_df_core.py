# ----------------------------------------------------------------------
# The preprocessing script to prepare the core dataframe to ensure results from the paper are replicated
# The paper uses PLS-SEM which involves automatic standardization of variables and one hot encoding. 
# This script performs the necessary steps to prepare the dataframe accordingly.
# ----------------------------------------------------------------------
