...
EXPERIMENTS_DIR <- "C:/Users/mithu/Documents/MEGA/VUW/Summer Research Project/Experiments/GReaT/Baseline"
...
for (SEED in SEEDS) {
  ...
  MODEL <- glue("{MODEL_BASE}_seed_{SEED}")
  ...
  input_file <- glue("synthetic_great_basic_{SEED}.csv")
  ...
  cat("Completed SEM for seed =", SEED, "\n")
}
