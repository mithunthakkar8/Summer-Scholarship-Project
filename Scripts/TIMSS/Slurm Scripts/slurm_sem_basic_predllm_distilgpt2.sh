...
#SBATCH --mem=32G
#SBATCH --time=5:00:00
#SBATCH --output=/nesi/project/vuw04485/slurm/basic_predllm_%j.out
#SBATCH --error=/nesi/project/vuw04485/slurm/basic_predllm_%j.err
...
cd /nesi/project/vuw04485/TIMSS/python
